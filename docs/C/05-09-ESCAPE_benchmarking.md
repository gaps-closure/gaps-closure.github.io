...
The benchmark plotting script is located in the same directory as the benchmarking program:
...
, uses the csv file outputs of the benchmarking program (see above). 
