...
At the time of this document, MIND and ILIP have been exhaustively tested in Phase 1 and Phase 2. Support for ESCAPE is in the pipeline and will be available by Phase 3.
...
Below is an example of the output from the HAL daemon, showing the configuration of the **XXX: ???**:
