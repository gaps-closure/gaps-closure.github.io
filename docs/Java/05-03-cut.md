## The cross-domain cut specification: cut.json **Mostly Done**
...
for the [code divider](#divider). It also contains information about the callee and caller that will be in the cut.
