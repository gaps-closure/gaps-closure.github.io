...
The usage of the conflict analyzer was described in the [previous section](#addl-notes).

### Modeling data and control flows 

Java CLOSURE uses JOANA @joana to construct system dependency graph (SDG) which
...
to extract the CLE annotations from a given jar file. Lastly we make use of
reflection feature in Java to relate fields and methods to their associated
...
### Design Decisions
The Java conflict analyzer permits unannotated classes to reside on multiple
enclaves. This choice was made to make our approach more practical. This design
